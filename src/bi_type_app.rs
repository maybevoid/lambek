...
pub trait BiTypeAppGenericCont
  < 'a, F: 'a, X: 'a, Y: 'a, R: 'a >
{
...
pub trait HasBiTypeApp
  < 'a, F: 'a + ?Sized, X: 'a + ?Sized, Y: 'a + ?Sized >
{
...
pub type BiApp < 'a, F, X, Y > =
  Box < dyn HasBiTypeApp < 'a, F, X, Y > + 'a >;
...
impl < 'a, F: 'a, X: 'a, Y: 'a, FX: 'a >
  HasBiTypeApp < 'a, F, X, Y >
  for FX
where
  F: BiTypeApp < 'a, X, Y, Applied = FX >
{
